	...
	<body>
		...
		<header id="nav-menu">
			...
			<div>
				<?php
					if($_SESSION['lang'] == $en) {
						echo '<button class="languageButton" onclick="window.location.href = \'./index.php?lang=it\';">'.$lang["lang"].'</button>';
					} else {
						echo '<button class="languageButton" onclick="window.location.href = \'./index.php?lang=en\';">'.$lang["lang"].'</button>';
					}
				?>	
			</div>
		</header>
		...
		<section class="description-section" data-aos="zoom-in">
			<div class="container">
				<div class="description">
					<h2>B&B Arena Alfieri</h2>
					<p><?php echo $lang['index_description']?></p>
				</div>
				<div class="box-item"> 
					<img class="box-image" src="./css/image/ArenaAlfieri2.jpg"/>
				</div> 
			</div>
		</section>
