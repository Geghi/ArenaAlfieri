	...
	<body>
		...
		<header id="nav-menu">
			...
			<div>
				<?php
					if($_SESSION['lang'] == $en) {
						echo '<button class="languageButton" onclick="window.location.href = \'./Libeccio.php?lang=it\';">'.$lang["lang"].'</button>';
					} else {
						echo '<button class="languageButton" onclick="window.location.href = \'./Libeccio.php?lang=en\';">'.$lang["lang"].'</button>';
					}
				?>
			</div>
		</header>
        ...
        <section id="start" class="description-section" data-aos="fade-in">
			...
			<div class="container">
				<div class="box-item"> 
					<img class="box-image" src="./css/image/libeccio1.jpg" alt=""/>
				</div> 
				<div class="box-item"> 
					<img class="box-image" src="./css/image/libeccio2.jpg" alt=""/>
				</div> 
            </div>
            
            <div class="container">
				<div class="box-item"> 
					<img class="box-image" src="./css/image/libeccio3.jpg" alt=""/>
				</div> 
				<div class="box-item"> 
                    <img class="box-image" src="./css/image/libeccio4.jpg" alt=""/>
