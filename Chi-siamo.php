	...
	<body>
		...
		<header id="nav-menu">
			...
			<div class="nav-list">
				<ul>
					...
					<li>
						<a href="Chi-siamo.php" class="nav-link active"><?php echo $lang['about'] ?></a>
					</li>
					<li>
			...
			<div>
				<?php
					if($_SESSION['lang'] == $en) {
						echo '<button class="languageButton" onclick="window.location.href = \'./Chi-siamo.php?lang=it\';">'.$lang["lang"].'</button>';
					} else {
						echo '<button class="languageButton" onclick="window.location.href = \'./Chi-siamo.php?lang=en\';">'.$lang["lang"].'</button>';
					}
				?>
			</div>
		</header>
		...
		<section id="start" class="description-section">
			<div class="container"  data-aos="zoom-in">
				...
				<div class="box-item"> 
					<img class="box-image" src="./css/image/colazioni.jpg"/>
				</div> 
			</div>
		</section>
