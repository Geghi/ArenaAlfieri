	...
	<body>
		...
		<header id="nav-menu">
			...
			<div>
				<?php
					if($_SESSION['lang'] == $en) {
						echo '<button class="languageButton" onclick="window.location.href = \'./Maestrale.php?lang=it\';">'.$lang["lang"].'</button>';
					} else {
						echo '<button class="languageButton" onclick="window.location.href = \'./Maestrale.php?lang=en\';">'.$lang["lang"].'</button>';
					}
				?>
			</div>
		</header>
        ...
        <section id="start" class="description-section"  data-aos="fade-in">
			...
			<div class="container">
				<div class="box-item"> 
					<img class="box-image" src="./css/image/meastrale1.jpg" alt=""/>
				</div> 
				<div class="box-item"> 
					<img class="box-image" src="./css/image/meastrale2.jpg" alt=""/>
				</div> 
            </div>
            
            <div class="container">
				<div class="box-item room-image"> 
					<img class="box-image" src="./css/image/meastrale5.jpg" alt=""/>
				</div> 
				<div class="box-item"> 
            ...
            <div class="container">
				<div class="box-item"> 
					<img class="box-image" src="./css/image/meastrale3.jpg" alt=""/>
				</div> 
				<div class="box-item "> 
					<img class="box-image" src="./css/image/meastrale4.jpg" alt=""/>
				</div> 
            </div>
