	...
	<body>
		...
		<header id="nav-menu">
			...
			<div>
				<?php
					if($_SESSION['lang'] == $en) {
						echo '<button class="languageButton" onclick="window.location.href = \'./Scirocco.php?lang=it\';">'.$lang["lang"].'</button>';
					} else {
						echo '<button class="languageButton" onclick="window.location.href = \'./Scirocco.php?lang=en\';">'.$lang["lang"].'</button>';
					}
				?>
			</div>
		</header>
        ...
        <section id="start" class="description-section"  data-aos="fade-in">
			...
			<div class="container">
				<div class="box-item"> 
					<img class="box-image" src="./css/image/scirocco1.jpg" alt=""/>
				</div> 
				<div class="box-item"> 
					<img class="box-image" src="./css/image/scirocco2.jpg" alt=""/>
				</div> 
            </div>
            
            <div class="container">
				<div class="box-item"> 
					<img class="box-image" src="./css/image/scirocco3.jpg" alt=""/>
				</div> 
				<div class="box-item"> 
                    <img class="box-image" src="./css/image/scirocco4.jpg" alt=""/>
